...
export class UserService {
  ...
  TimeChal (params) {
    return this.http.post(this.hostServer + '/rest/timechal', params).pipe(map((response: any) => response), catchError((err) => { throw err }))
  }

  evaluate (params) {
    return this.http.post(this.hostServer + '/rest/evaluate', params).pipe(map((response: any) => response), catchError((err) => { throw err }))
  }
