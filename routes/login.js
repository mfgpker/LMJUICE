...
module.exports = function login () {
  ...
  return (req, res, next) => {
    ...
    if (utils.notSolved(challenges.weakPasswordChallenge2) && req.body.email === 'lars@' + config.get('application.domain')  && req.body.password === 'mifmif62') {
      utils.solve(challenges.weakPasswordChallenge2)
    }
